...
extern const wm_drv_clock_ops_t wm_drv_clock_ops;
...
const static wm_dt_hw_pin_cfg_t dt_hw_uart0_pin[] = {
    { .pin_num = WM_GPIO_NUM_35, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT   },
    { .pin_num = WM_GPIO_NUM_36, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_PULL_UP },
};
...
const static wm_dt_hw_pin_cfg_t dt_hw_uart1_pin[] = {
    { .pin_num = WM_GPIO_NUM_22, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_INPUT, .pin_pupd = WM_GPIO_FLOAT   },
    { .pin_num = WM_GPIO_NUM_23, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_INPUT, .pin_pupd = WM_GPIO_PULL_UP },
};
...
const static wm_dt_hw_pin_cfg_t dt_hw_psram0_pin_cfg[] = {
    /**< board: EVB  */
    /**< SCLK */
    { .pin_num = WM_GPIO_NUM_15, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
    /**< CS */
    { .pin_num = WM_GPIO_NUM_43, .pin_mux = WM_GPIO_IOMUX_FUN1, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
    /**< SIO0 */
    { .pin_num = WM_GPIO_NUM_18, .pin_mux = WM_GPIO_IOMUX_FUN4, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
    /**< SIO1 */
    { .pin_num = WM_GPIO_NUM_19, .pin_mux = WM_GPIO_IOMUX_FUN4, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
    /**< SIO2 */
    { .pin_num = WM_GPIO_NUM_20, .pin_mux = WM_GPIO_IOMUX_FUN4, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
    /**< SIO3 */
    { .pin_num = WM_GPIO_NUM_21, .pin_mux = WM_GPIO_IOMUX_FUN4, .pin_dir = WM_GPIO_DIR_OUTPUT, .pin_pupd = WM_GPIO_FLOAT },
};

const static wm_dt_hw_psram_t dt_hw_psram0 = {
    ...
    .pin_cfg_count = sizeof(dt_hw_psram0_pin_cfg) / sizeof(dt_hw_psram0_pin_cfg[0]),
    .pin_cfg = (wm_dt_hw_pin_cfg_t*)dt_hw_psram0_pin_cfg,
    .dma_device_name = "dma",
    .rcc_device_name = "rcc"
};
#endif
...
const static wm_dt_hw_rsa_t dt_hw_rsa = {
    .reg_base = 0x40000000, .clock_device_name = "rcc", .init_cfg = { .init_level = 0, .init_priority = 50 }
};
#endif
...
#if CONFIG_COMPONENT_DRIVER_PSRAM_ENABLED
    { .dev_name = "psram0", .hw_addr = (void *)&dt_hw_psram0, .ops_addr = (void *)&wm_drv_psram_ops          },
#endif  /* CONFIG_COMPONENT_DRIVER_PSRAM_ENABLED */
#if CONFIG_COMPONENT_DRIVER_RCC_ENABLED
    { .dev_name = "rcc",    .hw_addr = (void *)&dt_hw_rcc,    .ops_addr = (void *)&wm_drv_clock_ops          },
