...
#if defined(CONFIG_WEBNET_USING_UPLOAD)
...
static char* _webnet_module_upload_parse_header(struct webnet_session* session, char* buffer, wm_size_t length)
{
    char *ptr, *ch, *end_ptr;
...
static char* _next_possible_boundary(struct webnet_session* session, char* buffer, wm_size_t length)
{
    char *ptr;
    struct webnet_module_upload_session *upload_session;
...
static void _handle_section(struct webnet_session* session, char* buffer, wm_size_t length)
{
    char *ptr;
    struct webnet_module_upload_session *upload_session;
...
int webnet_upload_file_write(struct webnet_session* session, const void* data, wm_size_t length)
{
#ifdef CONFIG_WEBNET_FS
    int fd;
    struct webnet_module_upload_session* upload_session;
