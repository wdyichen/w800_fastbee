...
void webnet_asp_add_var(const char* name, void (*handler)(struct webnet_session* session, void* handler_priv),
                        void* priv);
/* register CGI event */
void webnet_cgi_register(const char* name, void (*handler)(struct webnet_session* session, void* handler_priv),
                         void* priv);
...
struct webnet_module_upload_entry
{
    ...
    int (*upload_write)(struct webnet_session* session, const void* data, wm_size_t length);
